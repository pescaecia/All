   ...
   if (array_search($extensao, $_UP['extensoes']) === FALSE) {
      ...
      if($_REQUEST['acao'] == 'inserir'){
                ...
                if  (move_uploaded_file($_FILES['imagem']['tmp_name'], $_UP['pasta'] . $nome_final)) {
                    ...
                    echo "<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/All/Main.php'>";
                 ...
                 if  (move_uploaded_file($_FILES['imagem']['tmp_name'], $_UP['pasta'] . $nome_final)) {
                    mysqli_query($conector,"update publicacaoAdm set titulo='$titulo', conteudo='$conteudo', img='$nome_final' where id='$idPublicacao'");
                    ...
                    echo "<script> alert('Lixo humano 02');</script>";
                }
      }
